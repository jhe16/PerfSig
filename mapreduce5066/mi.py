...
workloadstart = 1617981243000 # 11:14:03
workloadend = 1617981299000 # 11:14:59

interval = 1000 # sampling interval 1s

#read log sequence
with open('logseq-5066.pickle', 'rb') as handle:
    logseq = pickle.load(handle)

# read function call time vector
with open('functimevector-5066.pickle', 'rb') as handle:
...
for func in functimevec:
    ...
    names.append(func)
    if func == 'org.apache.hadoop.mapred.TestJobEndNotifier':
        causenum = idx
    idx += 1
