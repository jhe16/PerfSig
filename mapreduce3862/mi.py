...
workloadstart = 1618546105000 # 00:08:25
workloadend = 1618546162000 # 00:09:22

interval = 1000 # sampling interval 1s

#read log sequence
with open('logseq-3862.pickle', 'rb') as handle:
    logseq = pickle.load(handle)

# read function call time vector
with open('functimevector-3862.pickle', 'rb') as handle:
