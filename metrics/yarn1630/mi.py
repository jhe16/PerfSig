...
workloadstart = 1620410548000   #14:02:28
bugtrigger = 1620410603000    #14:03:23
bugend = 1620410638000     #14:03:58
workloadend = 1620410638000    #14:03:58
...
cpu = []
time = []
with open('yarn1630-cpu.csv') as csv_file:
...
#read time vector
with open('functimevector-1630.pickle', 'rb') as handle:
...
# ax.legend(['root cause function (yarn-1630)'])
