...
cpu = []
time = []
with open('mapreduce7089-cpu.csv') as csv_file:
...
#read time vector
with open('functimevector-7089.pickle', 'rb') as handle:
...
# ax.legend(['root cause function (mapreduce-7089)'])
