...
cpu = []
time = []
with open('hadoop8614-cpu.csv') as csv_file:
...
#read time vector
with open('functimevector-8614.pickle', 'rb') as handle:
...
ax.plot(timeline, cpufigure, color = 'r')
...
# ax.legend(['root cause function (hadoop-8614)'])
