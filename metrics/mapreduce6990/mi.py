...
cpu = []
time = []
with open('mapreduce6990-cpu.csv') as csv_file:
...
#read time vector
with open('functimevector-6990.pickle', 'rb') as handle:
...
# ax.legend(['root cause function (mapreduce-6990)'])
