...
workloadstart = 1618587563000 # 11:39:23
workloadend = 1618587616000 # 11:40:16

interval = 1000 # sampling interval 1s

#read log sequence
with open('logseq-4089.pickle', 'rb') as handle:
    logseq = pickle.load(handle)

# read function call time vector
with open('functimevector-4089.pickle', 'rb') as handle:
...
for func in functimevec:
    ...
    names.append(func)
    if func == 'org.apache.hadoop.mapreduce.v2.app.TestTaskHeartbeatHandler':
        causenum = idx
    idx += 1
