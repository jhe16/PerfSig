...
bugend = 1611939980000 # 12:06:20
time = bugtrigger

# timevector["hadoop11252"] = [0 for _ in range(duration)]
while time < bugend:
    cnt = int((time - workloadstart) / interval)
    timevector["hadoop11252"][cnt] += interval
    time += interval
...
with open('functimevector-11252.pickle', 'wb') as handle:
