...
workloadstart = 1618537281000 # 21:41:21
workloadend = 1618537361000 # 21:42:41

interval = 1000 # sampling interval 1s

#read log sequence
with open('logseq-4301.pickle', 'rb') as handle:
    logseq = pickle.load(handle)

# read function call time vector
with open('functimevector-4301.pickle', 'rb') as handle:
